...
import ArticleViewMeta from "@/components/artikel/ArticleViewMeta";
import "swiper/css";
...
export default function Blogs({ parentClass = "section-opinion tf-spacing-1 home-latest-news" }) {
  ...
  // ✅ Fetch 3 artikel terbaru dari API
  useEffect(() => {
    let isMounted = true;
    ...
    const fetchArticles = async () => {
      try {
        ...
        const res = await api.get("/articles", {
          params: {
            per_page: 3,        // ✅ Hanya 3 artikel
            sort_order: "desc", // ✅ Terbaru dulu
            status: "published", // ✅ Hanya yang published
          },
        });
      ...
      <div className="tf-container">
        <div className="row">
          <div className="col-12">
            ...
            {/* ✅ Swiper Carousel - 3 Artikel Terbaru */}
            {!loading && !error && articles.length > 0 && (
              <Swiper
                dir="ltr"
                ...
                pagination={{ el: ".spd6", clickable: true }}
                navigation={{
                  prevEl: ".home-article-prev",
                  nextEl: ".home-article-next",
                }}
              >
                {articles.map((article) => (
                  <SwiperSlide className="swiper-slide" key={article.id}>
                    {/* ✅ Card Style - Sama seperti Blogs1.jsx */}
                    <div className="blog-article-item style-2 hover-img">
                      ...
                      <div className="article-content">
                        ...
                        {/* Read More Link */}
                        <Link href={`/artikel/${article.slug}`} className="tf-btn-link">
                ...
                <div className="sw-wrap-btn home-carousel-nav mt-48">
                  <div className="swiper-button-prev sw-button nav-prev-layout home-article-prev">
                    <i className="icon-arrow-left-3" />
                  </div>
                  <div className="sw-pagination sw-pagination-layout text-center spd6" />
                  <div className="swiper-button-next sw-button nav-next-layout home-article-next">
