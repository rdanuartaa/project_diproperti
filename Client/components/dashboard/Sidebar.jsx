      ...
      <div className="sidebar-menu-dashboard">
        <div className="menu-box">
          <ul className="box-menu-dashboard">
            ...
            >
              <Link className="nav-menu-link" href={`/admin/my-profile`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/my-package`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/my-favorites`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/my-save-search`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/review`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/my-property`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin/add-property`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
